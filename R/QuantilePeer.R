...
#' @description The \pkg{QuantilePeer} package simulates and estimates peer effect models including the quantile-based specification (Houndetoungan, 2025), and the models with Constant Elasticity of Substitution (CES)-based social norm (Boucher et al., 2024 \doi{10.3982/ECTA21048}).
#'
...
#' @references Houndetoungan, A. (2025). Quantile peer effect models.
